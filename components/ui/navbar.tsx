    ...
    return (
        <nav className={cn("absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-6 md:px-12", className)}>
            ...
            <div className="group relative cursor-pointer">
                <div className="absolute -inset-0.5 rounded-full bg-gradient-to-r from-purple-500 to-fuchsia-600 opacity-30 blur transition duration-500 group-hover:opacity-70" />
                <div className="relative flex items-center gap-2 rounded-full border border-white/10 bg-black/50 px-4 py-1.5 text-xs font-medium text-purple-100 backdrop-blur-md transition-colors hover:bg-white/5">
